  ...
  public static void main(String[] args) {
    ...
    public static void main(String[] args) {
        try {
            ...
            System.err.println("Se agotó la memoria: " + e.getMessage());
        }
    }
}

class ObjetoGrande {
    // Constructor que ocupa mucha memoria al instanciarse
    public ObjetoGrande() {
        // Simular consumo de memoria creando un gran array de bytes
